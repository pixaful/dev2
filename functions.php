...
if ( ! function_exists( 'pixaful_setup' ) ) :
	...
	function pixaful_setup() {
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'pixaful_custom_background_args',
				array(
...
function pixaful_scripts() {
	wp_enqueue_style( 'pixaful-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'pixaful-style', 'rtl', 'replace' );
	wp_enqueue_script('pixaful-font-awesome', ('https://kit.fontawesome.com/cb9efed43f.js'), array(), false,true); 
	wp_enqueue_script( 'pixaful-scripts', get_template_directory_uri() . '/js/scripts-set.js', array(), _S_VERSION, true );
...
function font_preloading_preload_key_requests() { ?>
	    <link rel="preload" as="font" type="font/woff2" href="/fonts/cabin-v18-latin-regular.woff2" crossorigin>
    <link rel="preload" as="font" type="font/woff2" href="/fonts/cabin-v18-latin-700.woff2" crossorigin>
    <link rel="preload" as="font" type="font/woff2" href="/fonts/merriweather-v22-latin-regular.woff2" crossorigin>
    <link rel="preload" as="font" type="font/woff2" href="/fonts/cabin-v18-latin-700.woff2" crossorigin>
    <link rel="preload" as="font" type="font/woff2" href="/fonts/merriweather-v22-latin-700.woff2" crossorigin>
<?php }
